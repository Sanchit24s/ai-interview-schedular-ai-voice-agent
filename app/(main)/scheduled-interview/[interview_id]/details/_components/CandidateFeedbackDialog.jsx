                ...
                <DialogHeader>
                    ...
                    <DialogDescription asChild>
                        <div>
                            ...
                            <div
                                className={`p-5 mt-10 flex items-center justify-between rounded-md ${feedback?.recommendation == "No"
                                    ? "bg-red-100"
                                    : "bg-green-100"
                                    }`}
                            >
                                <div>
                                    <h2
                                        className={`font-bold ${feedback?.recommendation == "No"
                                            ? "text-red-700"
                                            : "text-green-700"
                                            }`}
                                    >
                                    ...
                                    <p
                                        className={`${feedback?.recommendation == "No"
                                            ? "text-red-500"
                                            : "text-green-500"
                                            }`}
                                    >
                                ...
                                <Button className={`${feedback?.recommendation == "No"
                                    ? "bg-red-700"
                                    : "bg-green-700"
                                    }`}>Send Msg</Button>
                            </div>
